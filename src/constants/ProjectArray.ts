...
const NomadCoderArray = [
  {
    ...
    duration: '2023.08',
    description:
      '구글 크롬 확장 프로그램 모멘텀(Momentum)을 Javascript로 구현한 프로젝트',
    link: 'https://github.com/crohasang/momentum_js',
  },
  {
    ...
    duration: '2023.08',
    description:
      '별점이 8.5점 이상인 영화들을 정렬해서 보여주는 사이트를 React로 구현한 프로젝트',
    link: 'https://github.com/crohasang/React-Practice',
  },
  {
    ...
    duration: '2023.12',
    description:
      '간단한 해시 값 생성기를 만들며 Typescript 문법을 익히는 프로젝트',
    link: 'https://github.com/crohasang/ts_hash_generator',
  },
  {
    ...
    link: 'https://github.com/crohasang/twitter-clone-firebase',
  },
];
...
const JetpackComposeArray = [
  {
    ...
    description:
      '땀으로 쓰는 일기, SweatNote (운동 감정 기록 어플리케이션 제작 프로젝트)',
    link: 'https://github.com/crohasang/SweatNote',
  },
  {
    ...
    link: 'https://github.com/crohasang/EmergencyGuide',
  },
];

export { WebFrontEndArray, NomadCoderArray, JetpackComposeArray };
